...
import (
	...
	"github.com/netScaP/myprotest/api/middlewares"
	"github.com/netScaP/myprotest/api/models"
	"github.com/netScaP/myprotest/api/responses"
)
...
func home (w http.ResponseWriter, r *http.Request) {
	responses.JSON(w, http.StatusOK, "Welcome To MyProtest")
}